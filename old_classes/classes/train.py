...
def main():
    ...
    ap.add_argument("--train_dir", default=r"/home/texa_innovates/chromo/bgremove_img", help="Folder with ONLY good images")
    ap.add_argument("--out", default="oneclass_bg_visa.joblib", help="Artifact path to save")
